    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-gradient-to-br from-blue-300 to-blue-500 shadow-xl">
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-md">
        <button
          ...
          className="p-3 bg-yellow-500 text-white text-md sm:text-lg font-semibold rounded-xl hover:cursor-pointer shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-yellow-600 ring-2 ring-yellow-300 ring-opacity-50"
        >
          📖 Baca Quran
        </button>
        <button
          onClick={() => navigate("/jadwalsalat")}
          className="p-3 bg-green-600 text-white text-md sm:text-lg font-semibold hover:cursor-pointer rounded-xl shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-green-700 ring-2 ring-green-400 ring-opacity-50"
        >
          🕌 Jadwal Salat
        </button>
        <button
